    ...
    >
      <div className="min-h-screen bg-gradient-to-b from-emerald-50/80 via-rose-50/70 to-stone-50/80 backdrop-blur-[1px]">
        <div className="mx-auto max-w-5xl p-4 md:p-6">
          {/* Non-sticky header */}
       {/* Non-sticky header */}
<div className="rounded-3xl border border-black/5 bg-white/55 backdrop-blur shadow-sm overflow-hidden">
  <header className="px-4 py-4">
    ...
    <div className="mt-2 flex items-center justify-between gap-3">
      <div className="min-w-0 text-xs text-stone-600 truncate">{greeting}</div>
